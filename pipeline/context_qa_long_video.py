...
def _patch_orchestrator(orchestrator: Any) -> None:
    ...
    def process_long_video_with_context_qa(video_meta: dict) -> int:
        from pipeline.context_qa_gate import filter_duplicate_draft_candidates
        ...
        for person in persons:
            ...
            reels, events_by_reel, flagged = orchestrator._qa_gate(reels, events_out, activity, person.get("description", ""), _recompile)
