...
def main() -> int:
    ...
    for token in ["def quality_score", "def choose_climax", "_disable_teaser", "cut_clip_without_unqualified_teaser"]:
    ...
    ordered = order_events([bad_high, good_lower, ev("middle", 7, visible=0.8)])
